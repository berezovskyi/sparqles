...
public class AvailEp {
  ...
  public boolean equals(Object object) {
    if (object != null && object instanceof AvailEp)
      return ((AvailEp) object).getEpURI().equals(this.epURI);
    return false;
  }
    ...
    for (AvailEpMonthRecord record : records) {
      System.out.println(
          "\t["
              + record.getDate()
              + "]\t"
              + df.format(record.getNbSuccessTest() / record.getNbTests()));
    }
  }
  ...
  public class AvailEpMonthRecord {
    ...
    public AvailEpMonthRecord(String date) {
      this.date = date;
    }
    ...
    @Override
    public boolean equals(Object object) {
      if (object != null && object instanceof AvailEpMonthRecord)
        return ((AvailEpMonthRecord) object).getDate().equals(this.date);
      return false;
    }
  }
}
