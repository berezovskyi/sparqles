...
public class EndpointResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static EndpointResult fromByteBuffer(
   ...
   */
  public EndpointResult(sparqles.avro.Endpoint endpoint, java.lang.Long start, java.lang.Long end) {
   ...
   * @return A new EndpointResult RecordBuilder
   */
  public static sparqles.avro.EndpointResult.Builder newBuilder(sparqles.avro.EndpointResult.Builder other) {
    if (other == null) {
      return new sparqles.avro.EndpointResult.Builder();
    } else {
   ...
   * @return A new EndpointResult RecordBuilder
   */
  public static sparqles.avro.EndpointResult.Builder newBuilder(sparqles.avro.EndpointResult other) {
    if (other == null) {
      return new sparqles.avro.EndpointResult.Builder();
    } else {
      return new sparqles.avro.EndpointResult.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EndpointResult>
    ...
    public sparqles.avro.EndpointResult.Builder setEndpointBuilder(sparqles.avro.Endpoint.Builder value) {
      clearEndpoint();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EndpointResult>
    WRITER$ = (org.apache.avro.io.DatumWriter<EndpointResult>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EndpointResult>
    READER$ = (org.apache.avro.io.DatumReader<EndpointResult>)MODEL$.createDatumReader(SCHEMA$);
