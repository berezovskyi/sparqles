...
public class EPViewCalculation extends org.apache.avro.specific.SpecificRecordBase
   ...
   *     this class
   */
  public static EPViewCalculation fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
  ...
  public static class Builder
    ...
    public EPViewCalculation build() {
      try {
        ...
        record.triples =
            fieldSetFlags()[0] ? this.triples : (java.lang.Long) defaultValue(fields()[0]);
        record.entities =
            fieldSetFlags()[1] ? this.entities : (java.lang.Long) defaultValue(fields()[1]);
        record.classes =
            fieldSetFlags()[2] ? this.classes : (java.lang.Long) defaultValue(fields()[2]);
        record.properties =
            fieldSetFlags()[3] ? this.properties : (java.lang.Long) defaultValue(fields()[3]);
        record.distinctSubjects =
            fieldSetFlags()[4] ? this.distinctSubjects : (java.lang.Long) defaultValue(fields()[4]);
        record.distinctObjects =
            fieldSetFlags()[5] ? this.distinctObjects : (java.lang.Long) defaultValue(fields()[5]);
        record.exampleResources =
            fieldSetFlags()[6]
                ? this.exampleResources
                : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[6]);
        record.VoID =
            fieldSetFlags()[7] ? this.VoID : (java.lang.CharSequence) defaultValue(fields()[7]);
        record.VoIDPart =
            fieldSetFlags()[8] ? this.VoIDPart : (java.lang.Boolean) defaultValue(fields()[8]);
        record.SD =
            fieldSetFlags()[9] ? this.SD : (java.lang.CharSequence) defaultValue(fields()[9]);
        record.SDPart =
            fieldSetFlags()[10] ? this.SDPart : (java.lang.Boolean) defaultValue(fields()[10]);
        record.coherence =
            fieldSetFlags()[11] ? this.coherence : (java.lang.Double) defaultValue(fields()[11]);
