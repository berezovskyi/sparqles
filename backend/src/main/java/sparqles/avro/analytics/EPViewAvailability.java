...
public class EPViewAvailability extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static EPViewAvailability fromByteBuffer(
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EPViewAvailability>
    ...
    private Builder(sparqles.avro.analytics.EPViewAvailability.Builder other) {
      ...
      if (other.hasDataBuilder()) {
        this.dataBuilder = sparqles.avro.analytics.EPViewAvailabilityData.newBuilder(other.getDataBuilder());
      }
    }
    ...
    public sparqles.avro.analytics.EPViewAvailability.Builder setDataBuilder(sparqles.avro.analytics.EPViewAvailabilityData.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EPViewAvailability>
    WRITER$ = (org.apache.avro.io.DatumWriter<EPViewAvailability>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EPViewAvailability>
    READER$ = (org.apache.avro.io.DatumReader<EPViewAvailability>)MODEL$.createDatumReader(SCHEMA$);
