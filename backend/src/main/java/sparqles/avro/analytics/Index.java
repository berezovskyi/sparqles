...
public class Index extends org.apache.avro.specific.SpecificRecordBase
  ...
  public Index(
      ...
      sparqles.avro.analytics.IndexViewCalculation calculation) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Index>
    ...
    private Builder(sparqles.avro.analytics.Index.Builder other) {
      ...
      if (other.hasPerformanceBuilder()) {
        this.performanceBuilder =
            sparqles.avro.analytics.IndexViewPerformance.newBuilder(other.getPerformanceBuilder());
      }
      ...
      if (other.hasCalculationBuilder()) {
        this.calculationBuilder =
            sparqles.avro.analytics.IndexViewCalculation.newBuilder(other.getCalculationBuilder());
      }
    }
      ...
      if (interoperabilityBuilder == null) {
        if (hasInteroperability()) {
          setInteroperabilityBuilder(
              sparqles.avro.analytics.IndexViewInteroperability.newBuilder(interoperability));
        } else {
          setInteroperabilityBuilder(
              sparqles.avro.analytics.IndexViewInteroperability.newBuilder());
        }
      ...
      if (discoverabilityBuilder == null) {
        if (hasDiscoverability()) {
          setDiscoverabilityBuilder(
              sparqles.avro.analytics.IndexViewDiscoverability.newBuilder(discoverability));
        } else {
    ...
    public Index build() {
      try {
        ...
        record.lastUpdate =
            fieldSetFlags()[1] ? this.lastUpdate : (java.lang.Long) defaultValue(fields()[1]);
        record.availability =
            fieldSetFlags()[2]
                ? this.availability
        ...
        if (performanceBuilder != null) {
          ...
          record.performance =
              fieldSetFlags()[3]
                  ? this.performance
                  : (sparqles.avro.analytics.IndexViewPerformance) defaultValue(fields()[3]);
        }
        if (interoperabilityBuilder != null) {
          try {
          ...
          record.interoperability =
              fieldSetFlags()[4]
                  ...
                  : (sparqles.avro.analytics.IndexViewInteroperability) defaultValue(fields()[4]);
        }
        if (discoverabilityBuilder != null) {
          try {
          ...
          record.discoverability =
              fieldSetFlags()[5]
                  ...
                  : (sparqles.avro.analytics.IndexViewDiscoverability) defaultValue(fields()[5]);
        }
        if (calculationBuilder != null) {
          try {
          ...
          record.calculation =
              fieldSetFlags()[6]
                  ? this.calculation
                  : (sparqles.avro.analytics.IndexViewCalculation) defaultValue(fields()[6]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
