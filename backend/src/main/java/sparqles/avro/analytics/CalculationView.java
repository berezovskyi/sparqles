  ...
  public static class Builder
    ...
    public CalculationView build() {
      try {
        ...
        record.VoID =
            fieldSetFlags()[1] ? this.VoID : (java.lang.Boolean) defaultValue(fields()[1]);
        record.VoIDPart =
            fieldSetFlags()[2] ? this.VoIDPart : (java.lang.Boolean) defaultValue(fields()[2]);
        record.SD = fieldSetFlags()[3] ? this.SD : (java.lang.Boolean) defaultValue(fields()[3]);
        record.SDPart =
            fieldSetFlags()[4] ? this.SDPart : (java.lang.Boolean) defaultValue(fields()[4]);
        record.coherence =
            fieldSetFlags()[5] ? this.coherence : (java.lang.Double) defaultValue(fields()[5]);
        record.RS = fieldSetFlags()[6] ? this.RS : (java.lang.Double) defaultValue(fields()[6]);
        record.lastUpdate =
            fieldSetFlags()[7] ? this.lastUpdate : (java.lang.Long) defaultValue(fields()[7]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
