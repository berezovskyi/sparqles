...
public class EPViewPerformanceData extends org.apache.avro.specific.SpecificRecordBase
   ...
   *     this class
   */
  public static EPViewPerformanceData fromByteBuffer(java.nio.ByteBuffer b)
  ...
  /**
   * Creates a new EPViewPerformanceData RecordBuilder by copying an existing EPViewPerformanceData
   * instance.
   *
    ...
    public EPViewPerformanceData build() {
      try {
        ...
        record.data =
            fieldSetFlags()[2]
                ? this.data
                : (java.util.List<sparqles.avro.analytics.EPViewPerformanceDataValues>)
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EPViewPerformanceData> WRITER$ =
      (org.apache.avro.io.DatumWriter<EPViewPerformanceData>) MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EPViewPerformanceData> READER$ =
      (org.apache.avro.io.DatumReader<EPViewPerformanceData>) MODEL$.createDatumReader(SCHEMA$);
  ...
  public void customDecode(org.apache.avro.io.ResolvingDecoder in) throws java.io.IOException {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 =
            new SpecificData.Array<sparqles.avro.analytics.EPViewPerformanceDataValues>(
                (int) size0, SCHEMA$.getField("data").schema());
        this.data = a0;
      } else a0.clear();
      SpecificData.Array<sparqles.avro.analytics.EPViewPerformanceDataValues> ga0 =
          (a0 instanceof SpecificData.Array
              ? (SpecificData.Array<sparqles.avro.analytics.EPViewPerformanceDataValues>) a0
              : null);
      for (; 0 < size0; size0 = in.arrayNext()) {
        for (; size0 != 0; size0--) {
          sparqles.avro.analytics.EPViewPerformanceDataValues e0 =
