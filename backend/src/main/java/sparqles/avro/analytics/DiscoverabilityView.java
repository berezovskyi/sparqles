...
public class DiscoverabilityView extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static DiscoverabilityView fromByteBuffer(
   ...
   * @return A new DiscoverabilityView RecordBuilder
   */
  public static sparqles.avro.analytics.DiscoverabilityView.Builder newBuilder(sparqles.avro.analytics.DiscoverabilityView.Builder other) {
    if (other == null) {
      return new sparqles.avro.analytics.DiscoverabilityView.Builder();
    } else {
   ...
   * @return A new DiscoverabilityView RecordBuilder
   */
  public static sparqles.avro.analytics.DiscoverabilityView.Builder newBuilder(sparqles.avro.analytics.DiscoverabilityView other) {
    if (other == null) {
      return new sparqles.avro.analytics.DiscoverabilityView.Builder();
    } else {
      return new sparqles.avro.analytics.DiscoverabilityView.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DiscoverabilityView>
    ...
    /**
      ...
      * @return This builder.
      */
    public sparqles.avro.analytics.DiscoverabilityView.Builder setEndpoint(sparqles.avro.Endpoint value) {
    ...
    public sparqles.avro.analytics.DiscoverabilityView.Builder setEndpointBuilder(sparqles.avro.Endpoint.Builder value) {
      clearEndpoint();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<DiscoverabilityView>
    WRITER$ = (org.apache.avro.io.DatumWriter<DiscoverabilityView>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DiscoverabilityView>
    READER$ = (org.apache.avro.io.DatumReader<DiscoverabilityView>)MODEL$.createDatumReader(SCHEMA$);
