...
public class EPViewInteroperability extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static EPViewInteroperability fromByteBuffer(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EPViewInteroperability>
    WRITER$ = (org.apache.avro.io.DatumWriter<EPViewInteroperability>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EPViewInteroperability>
    READER$ = (org.apache.avro.io.DatumReader<EPViewInteroperability>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<sparqles.avro.analytics.EPViewInteroperabilityData>((int)size0, SCHEMA$.getField("SPARQL1Features").schema());
        this.SPARQL1Features = a0;
      } else a0.clear();
      SpecificData.Array<sparqles.avro.analytics.EPViewInteroperabilityData> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<sparqles.avro.analytics.EPViewInteroperabilityData>)a0 : null);
      ...
      if (a1 == null) {
        a1 = new SpecificData.Array<sparqles.avro.analytics.EPViewInteroperabilityData>((int)size1, SCHEMA$.getField("SPARQL11Features").schema());
        this.SPARQL11Features = a1;
      } else a1.clear();
      SpecificData.Array<sparqles.avro.analytics.EPViewInteroperabilityData> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<sparqles.avro.analytics.EPViewInteroperabilityData>)a1 : null);
