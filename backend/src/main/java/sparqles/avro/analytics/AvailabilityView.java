...
public class AvailabilityView extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static AvailabilityView fromByteBuffer(
   ...
   */
  public AvailabilityView(sparqles.avro.Endpoint endpoint, java.lang.Boolean upNow, java.lang.Double uptimeLast24h, java.lang.Double uptimeLast7d, java.lang.Long lastUpdate) {
   ...
   * @return A new AvailabilityView RecordBuilder
   */
  public static sparqles.avro.analytics.AvailabilityView.Builder newBuilder(sparqles.avro.analytics.AvailabilityView.Builder other) {
    if (other == null) {
      return new sparqles.avro.analytics.AvailabilityView.Builder();
    } else {
   ...
   * @return A new AvailabilityView RecordBuilder
   */
  public static sparqles.avro.analytics.AvailabilityView.Builder newBuilder(sparqles.avro.analytics.AvailabilityView other) {
    if (other == null) {
      return new sparqles.avro.analytics.AvailabilityView.Builder();
    } else {
      return new sparqles.avro.analytics.AvailabilityView.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvailabilityView>
    ...
    /**
      ...
      * @return This builder.
      */
    public sparqles.avro.analytics.AvailabilityView.Builder setEndpoint(sparqles.avro.Endpoint value) {
    ...
    public sparqles.avro.analytics.AvailabilityView.Builder setEndpointBuilder(sparqles.avro.Endpoint.Builder value) {
      clearEndpoint();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AvailabilityView>
    WRITER$ = (org.apache.avro.io.DatumWriter<AvailabilityView>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvailabilityView>
    READER$ = (org.apache.avro.io.DatumReader<AvailabilityView>)MODEL$.createDatumReader(SCHEMA$);
