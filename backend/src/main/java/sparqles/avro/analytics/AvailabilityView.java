...
public class AvailabilityView extends org.apache.avro.specific.SpecificRecordBase
   ...
   *     this class
   */
  public static AvailabilityView fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
  ...
  public static class Builder
    ...
    public AvailabilityView build() {
      try {
        ...
        record.upNow =
            fieldSetFlags()[1] ? this.upNow : (java.lang.Boolean) defaultValue(fields()[1]);
        ...
        record.lastUpdate =
            fieldSetFlags()[4] ? this.lastUpdate : (java.lang.Long) defaultValue(fields()[4]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
