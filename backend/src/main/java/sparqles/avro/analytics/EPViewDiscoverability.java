...
public class EPViewDiscoverability extends org.apache.avro.specific.SpecificRecordBase
    ...
    @Deprecated
    public java.util.List<sparqles.avro.analytics.EPViewDiscoverabilityData> VoIDDescription;

    @Deprecated
    public java.util.List<sparqles.avro.analytics.EPViewDiscoverabilityData> SDDescription;
