...
public class EPViewDiscoverability extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static EPViewDiscoverability fromByteBuffer(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EPViewDiscoverability>
    WRITER$ = (org.apache.avro.io.DatumWriter<EPViewDiscoverability>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EPViewDiscoverability>
    READER$ = (org.apache.avro.io.DatumReader<EPViewDiscoverability>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.serverName = in.readString(this.serverName instanceof Utf8 ? (Utf8)this.serverName : null);

      long size0 = in.readArrayStart();
      java.util.List<sparqles.avro.analytics.EPViewDiscoverabilityData> a0 = this.VoIDDescription;
      if (a0 == null) {
        a0 = new SpecificData.Array<sparqles.avro.analytics.EPViewDiscoverabilityData>((int)size0, SCHEMA$.getField("VoIDDescription").schema());
        this.VoIDDescription = a0;
      } else a0.clear();
      SpecificData.Array<sparqles.avro.analytics.EPViewDiscoverabilityData> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<sparqles.avro.analytics.EPViewDiscoverabilityData>)a0 : null);
      ...
      if (a1 == null) {
        a1 = new SpecificData.Array<sparqles.avro.analytics.EPViewDiscoverabilityData>((int)size1, SCHEMA$.getField("SDDescription").schema());
        this.SDDescription = a1;
      } else a1.clear();
      SpecificData.Array<sparqles.avro.analytics.EPViewDiscoverabilityData> ga1 = (a1 instanceof SpecificData.Array ? (SpecificData.Array<sparqles.avro.analytics.EPViewDiscoverabilityData>)a1 : null);
