...
public class IndexViewInterData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static IndexViewInterData fromByteBuffer(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<IndexViewInterData>
    WRITER$ = (org.apache.avro.io.DatumWriter<IndexViewInterData>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<IndexViewInterData>
    READER$ = (org.apache.avro.io.DatumReader<IndexViewInterData>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<sparqles.avro.analytics.IndexViewInterDataValues>((int)size0, SCHEMA$.getField("data").schema());
        this.data = a0;
      } else a0.clear();
      SpecificData.Array<sparqles.avro.analytics.IndexViewInterDataValues> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<sparqles.avro.analytics.IndexViewInterDataValues>)a0 : null);
