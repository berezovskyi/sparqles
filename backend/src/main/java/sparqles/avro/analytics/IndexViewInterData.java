...
public class IndexViewInterData extends org.apache.avro.specific.SpecificRecordBase
    ...
    public static class Builder
         ...
         * @return This builder.
         */
        public sparqles.avro.analytics.IndexViewInterData.Builder setKey(
        ...
        if (fieldOrder == null) {
            ...
            SpecificData.Array<sparqles.avro.analytics.IndexViewInterDataValues> ga0 =
                    (a0 instanceof SpecificData.Array
                            ? (SpecificData.Array<sparqles.avro.analytics.IndexViewInterDataValues>)
                                    a0
                            : null);
            ...
            for (int i = 0; i < 3; i++) {
                switch (fieldOrder[i].pos()) {
                    ...
                    case 2:
                        long size0 = in.readArrayStart();
                        java.util.List<sparqles.avro.analytics.IndexViewInterDataValues> a0 =
                                this.data;
                        if (a0 == null) {
                            a0 =
                                    new SpecificData.Array<
                                            sparqles.avro.analytics.IndexViewInterDataValues>(
                                            (int) size0, SCHEMA$.getField("data").schema());
                            this.data = a0;
                        } else a0.clear();
                        SpecificData.Array<sparqles.avro.analytics.IndexViewInterDataValues> ga0 =
