...
public class IndexViewCalculationData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static IndexViewCalculationData fromByteBuffer(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<IndexViewCalculationData>
    WRITER$ = (org.apache.avro.io.DatumWriter<IndexViewCalculationData>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<IndexViewCalculationData>
    READER$ = (org.apache.avro.io.DatumReader<IndexViewCalculationData>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<sparqles.avro.analytics.IndexViewCalculationDataValues>((int)size0, SCHEMA$.getField("values").schema());
        this.values = a0;
      } else a0.clear();
      SpecificData.Array<sparqles.avro.analytics.IndexViewCalculationDataValues> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<sparqles.avro.analytics.IndexViewCalculationDataValues>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          sparqles.avro.analytics.IndexViewCalculationDataValues e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
