...
public class IndexViewPerformance extends org.apache.avro.specific.SpecificRecordBase
    ...
    private static final org.apache.avro.io.DatumWriter<IndexViewPerformance> WRITER$ =
            (org.apache.avro.io.DatumWriter<IndexViewPerformance>)
    ...
    private static final org.apache.avro.io.DatumReader<IndexViewPerformance> READER$ =
            (org.apache.avro.io.DatumReader<IndexViewPerformance>)
        ...
        if (fieldOrder == null) {
            ...
            SpecificData.Array<sparqles.avro.analytics.IndexViewPerformanceData> ga0 =
                    (a0 instanceof SpecificData.Array
                            ? (SpecificData.Array<sparqles.avro.analytics.IndexViewPerformanceData>)
                                    a0
                            : null);
            ...
            for (int i = 0; i < 2; i++) {
                switch (fieldOrder[i].pos()) {
                    ...
                    case 1:
                        long size0 = in.readArrayStart();
                        java.util.List<sparqles.avro.analytics.IndexViewPerformanceData> a0 =
                                this.data;
                        if (a0 == null) {
                            a0 =
                                    new SpecificData.Array<
                                            sparqles.avro.analytics.IndexViewPerformanceData>(
                                            (int) size0, SCHEMA$.getField("data").schema());
                            this.data = a0;
                        } else a0.clear();
                        SpecificData.Array<sparqles.avro.analytics.IndexViewPerformanceData> ga0 =
