...
public class EPViewPerformance extends org.apache.avro.specific.SpecificRecordBase
     ...
     *     this class
     */
    public static EPViewPerformance fromByteBuffer(java.nio.ByteBuffer b)
        ...
        if (fieldOrder == null) {
            ...
            for (int i = 0; i < 3; i++) {
                switch (fieldOrder[i].pos()) {
                        ...
                        if (a0 == null) {
                            a0 =
                                    new SpecificData.Array<
                                            sparqles.avro.analytics.EPViewPerformanceData>(
                                            (int) size0, SCHEMA$.getField("ask").schema());
                            this.ask = a0;
                        } else a0.clear();
                        SpecificData.Array<sparqles.avro.analytics.EPViewPerformanceData> ga0 =
                    ...
                    case 2:
                        long size1 = in.readArrayStart();
                        java.util.List<sparqles.avro.analytics.EPViewPerformanceData> a1 =
                                this.join;
                        if (a1 == null) {
                            a1 =
                                    new SpecificData.Array<
