...
public class IndexViewInterDataValues extends org.apache.avro.specific.SpecificRecordBase
    implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2362170334397943618L;
  ...
  private static final BinaryMessageEncoder<IndexViewInterDataValues> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<IndexViewInterDataValues> DECODER =
   ...
   */
  public static BinaryMessageEncoder<IndexViewInterDataValues> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<IndexViewInterDataValues> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<IndexViewInterDataValues> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this IndexViewInterDataValues to a ByteBuffer.
   *
  ...
  /**
   * Deserializes a IndexViewInterDataValues from a ByteBuffer.
   *
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a IndexViewInterDataValues instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of
   *     this class
   */
  public static IndexViewInterDataValues fromByteBuffer(java.nio.ByteBuffer b)
   ...
   *
   * @return A new IndexViewInterDataValues RecordBuilder
   */
  ...
  public static class Builder
      extends org.apache.avro.specific.SpecificRecordBuilderBase<IndexViewInterDataValues>
     ...
     * @return This builder.
     */
    public sparqles.avro.analytics.IndexViewInterDataValues.Builder setLabel(
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<IndexViewInterDataValues> WRITER$ =
      (org.apache.avro.io.DatumWriter<IndexViewInterDataValues>) MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<IndexViewInterDataValues> READER$ =
      (org.apache.avro.io.DatumReader<IndexViewInterDataValues>) MODEL$.createDatumReader(SCHEMA$);
