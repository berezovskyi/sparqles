...
public class IndexViewDiscoverability extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static IndexViewDiscoverability fromByteBuffer(
   ...
   */
  public IndexViewDiscoverability(java.util.List<sparqles.avro.analytics.IndexViewDiscoverabilityData> serverName, java.lang.Double VoIDDescription, java.lang.Double SDDescription, java.lang.Double NoDescription) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: serverName = (java.util.List<sparqles.avro.analytics.IndexViewDiscoverabilityData>)value$; break;
   ...
   */
  public void setServerName(java.util.List<sparqles.avro.analytics.IndexViewDiscoverabilityData> value) {
   ...
   * @return A new IndexViewDiscoverability RecordBuilder
   */
  public static sparqles.avro.analytics.IndexViewDiscoverability.Builder newBuilder(sparqles.avro.analytics.IndexViewDiscoverability.Builder other) {
    if (other == null) {
      return new sparqles.avro.analytics.IndexViewDiscoverability.Builder();
    } else {
   ...
   * @return A new IndexViewDiscoverability RecordBuilder
   */
  public static sparqles.avro.analytics.IndexViewDiscoverability.Builder newBuilder(sparqles.avro.analytics.IndexViewDiscoverability other) {
    if (other == null) {
      return new sparqles.avro.analytics.IndexViewDiscoverability.Builder();
    } else {
      return new sparqles.avro.analytics.IndexViewDiscoverability.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<IndexViewDiscoverability>
    ...
    /**
      ...
      * @return This builder.
      */
    public sparqles.avro.analytics.IndexViewDiscoverability.Builder setServerName(java.util.List<sparqles.avro.analytics.IndexViewDiscoverabilityData> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sparqles.avro.analytics.IndexViewDiscoverability.Builder setVoIDDescription(double value) {
    ...
    public IndexViewDiscoverability build() {
      try {
        ...
        record.serverName = fieldSetFlags()[0] ? this.serverName : (java.util.List<sparqles.avro.analytics.IndexViewDiscoverabilityData>) defaultValue(fields()[0]);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<IndexViewDiscoverability>
    WRITER$ = (org.apache.avro.io.DatumWriter<IndexViewDiscoverability>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<IndexViewDiscoverability>
    READER$ = (org.apache.avro.io.DatumReader<IndexViewDiscoverability>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (a0 == null) {
        a0 = new SpecificData.Array<sparqles.avro.analytics.IndexViewDiscoverabilityData>((int)size0, SCHEMA$.getField("serverName").schema());
        this.serverName = a0;
      } else a0.clear();
      SpecificData.Array<sparqles.avro.analytics.IndexViewDiscoverabilityData> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<sparqles.avro.analytics.IndexViewDiscoverabilityData>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          sparqles.avro.analytics.IndexViewDiscoverabilityData e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
