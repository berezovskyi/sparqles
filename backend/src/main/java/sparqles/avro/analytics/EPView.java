...
public class EPView extends org.apache.avro.specific.SpecificRecordBase
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EPView>
    ...
    private Builder(sparqles.avro.analytics.EPView.Builder other) {
      ...
      if (other.hasAvailabilityBuilder()) {
        this.availabilityBuilder =
            sparqles.avro.analytics.EPViewAvailability.newBuilder(other.getAvailabilityBuilder());
      }
      ...
      if (other.hasPerformanceBuilder()) {
        this.performanceBuilder =
            sparqles.avro.analytics.EPViewPerformance.newBuilder(other.getPerformanceBuilder());
      }
      ...
      if (other.hasCalculationBuilder()) {
        this.calculationBuilder =
            sparqles.avro.analytics.EPViewCalculation.newBuilder(other.getCalculationBuilder());
      }
    }
    ...
    /**
     * Gets the Builder instance for the 'availability' field and creates one if it doesn't exist
     * yet.
     *
     * @return This builder.
     */
      ...
      if (interoperabilityBuilder == null) {
        if (hasInteroperability()) {
          setInteroperabilityBuilder(
              sparqles.avro.analytics.EPViewInteroperability.newBuilder(interoperability));
        } else {
    ...
    /**
     * Gets the Builder instance for the 'discoverability' field and creates one if it doesn't exist
     * yet.
     *
     * @return This builder.
     */
      ...
      if (discoverabilityBuilder == null) {
        if (hasDiscoverability()) {
          setDiscoverabilityBuilder(
              sparqles.avro.analytics.EPViewDiscoverability.newBuilder(discoverability));
        } else {
      ...
      try {
        ...
        if (availabilityBuilder != null) {
          ...
          record.availability =
              fieldSetFlags()[1]
                  ? this.availability
                  : (sparqles.avro.analytics.EPViewAvailability) defaultValue(fields()[1]);
        }
        if (performanceBuilder != null) {
          try {
          ...
          record.performance =
              fieldSetFlags()[2]
                  ? this.performance
                  : (sparqles.avro.analytics.EPViewPerformance) defaultValue(fields()[2]);
        }
        if (interoperabilityBuilder != null) {
          try {
          ...
          record.interoperability =
              fieldSetFlags()[3]
                  ...
                  : (sparqles.avro.analytics.EPViewInteroperability) defaultValue(fields()[3]);
        }
        if (discoverabilityBuilder != null) {
          try {
          ...
          record.discoverability =
              fieldSetFlags()[4]
                  ...
                  : (sparqles.avro.analytics.EPViewDiscoverability) defaultValue(fields()[4]);
        }
        if (calculationBuilder != null) {
          try {
          ...
          record.calculation =
              fieldSetFlags()[5]
                  ? this.calculation
                  : (sparqles.avro.analytics.EPViewCalculation) defaultValue(fields()[5]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
