...
public class EPView extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static EPView fromByteBuffer(
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: calculation = (sparqles.avro.analytics.EPViewCalculation)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EPView>
    ...
    private Builder(sparqles.avro.analytics.EPView.Builder other) {
      ...
      if (other.hasAvailabilityBuilder()) {
        this.availabilityBuilder = sparqles.avro.analytics.EPViewAvailability.newBuilder(other.getAvailabilityBuilder());
      }
      ...
      if (other.hasPerformanceBuilder()) {
        this.performanceBuilder = sparqles.avro.analytics.EPViewPerformance.newBuilder(other.getPerformanceBuilder());
      }
      ...
      if (other.hasInteroperabilityBuilder()) {
        this.interoperabilityBuilder = sparqles.avro.analytics.EPViewInteroperability.newBuilder(other.getInteroperabilityBuilder());
      }
      ...
      if (other.hasDiscoverabilityBuilder()) {
        this.discoverabilityBuilder = sparqles.avro.analytics.EPViewDiscoverability.newBuilder(other.getDiscoverabilityBuilder());
      }
      ...
      if (other.hasCalculationBuilder()) {
        this.calculationBuilder = sparqles.avro.analytics.EPViewCalculation.newBuilder(other.getCalculationBuilder());
      }
    }
    ...
    public sparqles.avro.analytics.EPView.Builder setEndpointBuilder(sparqles.avro.Endpoint.Builder value) {
      clearEndpoint();
    ...
    /**
     * Gets the Builder instance for the 'availability' field and creates one if it doesn't exist yet.
     * @return This builder.
     */
    public sparqles.avro.analytics.EPViewAvailability.Builder getAvailabilityBuilder() {
      if (availabilityBuilder == null) {
        if (hasAvailability()) {
          setAvailabilityBuilder(sparqles.avro.analytics.EPViewAvailability.newBuilder(availability));
        } else {
    ...
    public sparqles.avro.analytics.EPView.Builder setAvailabilityBuilder(sparqles.avro.analytics.EPViewAvailability.Builder value) {
      clearAvailability();
    ...
    public sparqles.avro.analytics.EPViewPerformance.Builder getPerformanceBuilder() {
      if (performanceBuilder == null) {
        if (hasPerformance()) {
          setPerformanceBuilder(sparqles.avro.analytics.EPViewPerformance.newBuilder(performance));
        } else {
    ...
    public sparqles.avro.analytics.EPView.Builder setPerformanceBuilder(sparqles.avro.analytics.EPViewPerformance.Builder value) {
      clearPerformance();
    ...
    public sparqles.avro.analytics.EPViewInteroperability.Builder getInteroperabilityBuilder() {
      if (interoperabilityBuilder == null) {
        if (hasInteroperability()) {
          setInteroperabilityBuilder(sparqles.avro.analytics.EPViewInteroperability.newBuilder(interoperability));
        } else {
          setInteroperabilityBuilder(sparqles.avro.analytics.EPViewInteroperability.newBuilder());
        }
      }
    ...
    public sparqles.avro.analytics.EPView.Builder setInteroperabilityBuilder(sparqles.avro.analytics.EPViewInteroperability.Builder value) {
    ...
    public sparqles.avro.analytics.EPViewDiscoverability.Builder getDiscoverabilityBuilder() {
      if (discoverabilityBuilder == null) {
        if (hasDiscoverability()) {
          setDiscoverabilityBuilder(sparqles.avro.analytics.EPViewDiscoverability.newBuilder(discoverability));
        } else {
          setDiscoverabilityBuilder(sparqles.avro.analytics.EPViewDiscoverability.newBuilder());
        }
      }
    ...
    public sparqles.avro.analytics.EPView.Builder setDiscoverabilityBuilder(sparqles.avro.analytics.EPViewDiscoverability.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public sparqles.avro.analytics.EPView.Builder setCalculation(sparqles.avro.analytics.EPViewCalculation value) {
    ...
    public sparqles.avro.analytics.EPViewCalculation.Builder getCalculationBuilder() {
      if (calculationBuilder == null) {
        if (hasCalculation()) {
          setCalculationBuilder(sparqles.avro.analytics.EPViewCalculation.newBuilder(calculation));
        } else {
    ...
    public sparqles.avro.analytics.EPView.Builder setCalculationBuilder(sparqles.avro.analytics.EPViewCalculation.Builder value) {
      clearCalculation();
    ...
    public EPView build() {
      try {
        ...
        if (calculationBuilder != null) {
          ...
          record.calculation = fieldSetFlags()[5] ? this.calculation : (sparqles.avro.analytics.EPViewCalculation) defaultValue(fields()[5]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<EPView>
    WRITER$ = (org.apache.avro.io.DatumWriter<EPView>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<EPView>
    READER$ = (org.apache.avro.io.DatumReader<EPView>)MODEL$.createDatumReader(SCHEMA$);
