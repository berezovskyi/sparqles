...
public class IndexViewCalculationDataValues extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7990489637718673347L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"IndexViewCalculationDataValues\",\"namespace\":\"sparqles.avro.analytics\",\"fields\":[{\"name\":\"label\",\"type\":\"string\"},{\"name\":\"value\",\"type\":\"double\"}]}");
   ...
   */
  public static BinaryMessageDecoder<IndexViewCalculationDataValues> createDecoder(SchemaStore resolver) {
   ...
   */
  public static IndexViewCalculationDataValues fromByteBuffer(
   ...
   * @return A new IndexViewCalculationDataValues RecordBuilder
   */
  public static sparqles.avro.analytics.IndexViewCalculationDataValues.Builder newBuilder(sparqles.avro.analytics.IndexViewCalculationDataValues.Builder other) {
    if (other == null) {
      return new sparqles.avro.analytics.IndexViewCalculationDataValues.Builder();
    } else {
  ...
  /**
   * Creates a new IndexViewCalculationDataValues RecordBuilder by copying an existing IndexViewCalculationDataValues instance.
   * @param other The existing instance to copy.
   * @return A new IndexViewCalculationDataValues RecordBuilder
   */
  public static sparqles.avro.analytics.IndexViewCalculationDataValues.Builder newBuilder(sparqles.avro.analytics.IndexViewCalculationDataValues other) {
    if (other == null) {
      return new sparqles.avro.analytics.IndexViewCalculationDataValues.Builder();
    } else {
      return new sparqles.avro.analytics.IndexViewCalculationDataValues.Builder(other);
   ...
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<IndexViewCalculationDataValues>
    ...
    /**
      ...
      * @return This builder.
      */
    public sparqles.avro.analytics.IndexViewCalculationDataValues.Builder setLabel(java.lang.CharSequence value) {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<IndexViewCalculationDataValues>
    WRITER$ = (org.apache.avro.io.DatumWriter<IndexViewCalculationDataValues>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<IndexViewCalculationDataValues>
    READER$ = (org.apache.avro.io.DatumReader<IndexViewCalculationDataValues>)MODEL$.createDatumReader(SCHEMA$);
