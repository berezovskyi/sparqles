  ...
  public static class Builder
    ...
    public PerformanceView build() {
      try {
        ...
        record.askMeanCold =
            fieldSetFlags()[1] ? this.askMeanCold : (java.lang.Double) defaultValue(fields()[1]);
        record.askMeanWarm =
            fieldSetFlags()[2] ? this.askMeanWarm : (java.lang.Double) defaultValue(fields()[2]);
        record.joinMeanCold =
            fieldSetFlags()[3] ? this.joinMeanCold : (java.lang.Double) defaultValue(fields()[3]);
        record.joinMeanWarm =
            fieldSetFlags()[4] ? this.joinMeanWarm : (java.lang.Double) defaultValue(fields()[4]);
        record.lastUpdate =
            fieldSetFlags()[5] ? this.lastUpdate : (java.lang.Long) defaultValue(fields()[5]);
        record.threshold =
            fieldSetFlags()[6] ? this.threshold : (java.lang.Long) defaultValue(fields()[6]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
