...
public class DResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static DResult fromByteBuffer(
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DResult>
    ...
    private Builder(sparqles.avro.discovery.DResult.Builder other) {
      ...
      if (other.hasRobotsTXTBuilder()) {
        this.RobotsTXTBuilder = sparqles.avro.discovery.RobotsTXT.newBuilder(other.getRobotsTXTBuilder());
      }
    ...
    public sparqles.avro.discovery.DResult.Builder setEndpointResultBuilder(sparqles.avro.EndpointResult.Builder value) {
      clearEndpointResult();
    ...
    public sparqles.avro.discovery.DResult.Builder setRobotsTXTBuilder(sparqles.avro.discovery.RobotsTXT.Builder value) {
      clearRobotsTXT();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<DResult>
    WRITER$ = (org.apache.avro.io.DatumWriter<DResult>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DResult>
    READER$ = (org.apache.avro.io.DatumReader<DResult>)MODEL$.createDatumReader(SCHEMA$);
