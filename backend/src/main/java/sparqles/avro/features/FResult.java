...
public class FResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static FResult fromByteBuffer(
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FResult>
    ...
    public sparqles.avro.features.FResult.Builder setEndpointResultBuilder(sparqles.avro.EndpointResult.Builder value) {
      clearEndpointResult();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<FResult>
    WRITER$ = (org.apache.avro.io.DatumWriter<FResult>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<FResult>
    READER$ = (org.apache.avro.io.DatumReader<FResult>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (java.util.Map.Entry<java.lang.CharSequence, sparqles.avro.features.FSingleResult> e0: this.results.entrySet()) {
      actualSize0++;
      out.startItem();
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.Map<java.lang.CharSequence,sparqles.avro.features.FSingleResult> m0 = this.results; // Need fresh name due to limitation of macro system
      if (m0 == null) {
        m0 = new java.util.HashMap<java.lang.CharSequence,sparqles.avro.features.FSingleResult>((int)(size0 * 4)/3 + 1);
        this.results = m0;
      } else m0.clear();
