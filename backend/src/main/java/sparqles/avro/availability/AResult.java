...
public class AResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AResult>
    ...
    public sparqles.avro.availability.AResult.Builder setEndpointResultBuilder(sparqles.avro.EndpointResult.Builder value) {
      clearEndpointResult();
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 0) {
        ...
        this.explanation = in.readString(this.explanation instanceof Utf8 ? (Utf8)this.explanation : null);
      }
