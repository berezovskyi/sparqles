  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AResult>
    ...
    public AResult build() {
      try {
        ...
        record.responseTime =
            fieldSetFlags()[1] ? this.responseTime : (java.lang.Long) defaultValue(fields()[1]);
        record.isAvailable =
            fieldSetFlags()[2] ? this.isAvailable : (java.lang.Boolean) defaultValue(fields()[2]);
        record.isPrivate =
            fieldSetFlags()[3] ? this.isPrivate : (java.lang.Boolean) defaultValue(fields()[3]);
        record.Exception =
            fieldSetFlags()[4]
                ? this.Exception
  ...
  public void customDecode(org.apache.avro.io.ResolvingDecoder in) throws java.io.IOException {
    ...
    if (fieldOrder == null) {
      ...
      if (in.readIndex() != 0) {
        ...
        this.explanation =
            in.readString(this.explanation instanceof Utf8 ? (Utf8) this.explanation : null);
      }
