...
public class SitemapHandler extends DefaultHandler {
  ...
  public void startElement(String uri, String localName, String qName, Attributes attributes)
    ...
    sparqlEP =
        uri.equalsIgnoreCase("http://sw.deri.org/2007/07/sitemapextension/scschema.xsd")
            && localName.equalsIgnoreCase("sparqlEndpointLocation");
    datasetURI =
        uri.equalsIgnoreCase("http://sw.deri.org/2007/07/sitemapextension/scschema.xsd")
            && localName.equalsIgnoreCase("datasetURI");

    //		if(sparqlEP || datasetURI)
    //			System.out.println("Start: "+uri+ " lname:"+localName+" qName:"+qName + " attr:"+
    // attributes);
    if (sparqlEP) _rtxt.setSitemapXMLSPARQL(true);
  }
