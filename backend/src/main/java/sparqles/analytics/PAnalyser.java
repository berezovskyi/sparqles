  ...
  public boolean analyse(PResult pres) {
    ...
    EPViewPerformanceData askCold =
        new EPViewPerformanceData(
            "Cold ASK Tests", "#1f77b4", new ArrayList<EPViewPerformanceDataValues>());
    EPViewPerformanceData askWarm =
        new EPViewPerformanceData(
            "Warm ASK Tests", "#2ca02c", new ArrayList<EPViewPerformanceDataValues>());
    EPViewPerformanceData joinCold =
        new EPViewPerformanceData(
            "Cold JOIN Tests", "#1f77b4", new ArrayList<EPViewPerformanceDataValues>());
    EPViewPerformanceData joinWarm =
        new EPViewPerformanceData(
            "Warm JOIN Tests", "#2ca02c", new ArrayList<EPViewPerformanceDataValues>());
